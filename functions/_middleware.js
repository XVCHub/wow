...
<body>
  <div class="container">
    ...
    <p style="color: #666; margin-bottom: 20px;">Click to copy invite link</p>
    <div class="invite-link">discord.gg/rTw5M8dRXN</div>
    <button class="btn" onclick="copyInvite()">Copy Invite</button>
    <a href="https://discord.gg/rTw5M8dRXN" target="_blank" class="btn" style="background: #57F287;">Join Discord</a>
    <p class="success" id="successMsg">Copied to clipboard!</p>
  </div>
  <script>
    function copyInvite() {
      const link = 'discord.gg/rTw5M8dRXN';
...
function Input.StopCapture()
    ...
    for k in pairs(mouse) do
        mouse[k] = type(mouse[k]) == "number" and 0 or Vector2.new()
    end
end
