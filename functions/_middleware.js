    ...
    if (!filename.includes('.')) {
      ...
      if (filesResponse.ok) {
        ...
        for (let i = 0; i < files.length; i++) {
          ...
          const versionPattern = '^' + baseName + 'v([0-9]+)\\.(lua|txt|js|py|png|jpg|jpeg|gif|webp|svg)' + '$';
          const versionMatch = name.match(new RegExp(versionPattern));
